 ...
 * 
 */
public class SimpleStoreActivityS3Impl implements SimpleStoreActivity {
    ...
    public SimpleStoreActivityS3Impl(AmazonS3 s3Client, String localDirectory, String taskList) {
