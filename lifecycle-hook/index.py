...
def get_cmds():
    return [
        {'description': 'Remove java 7', 'command': 'yum remove -y java-1.7.0-openjdk'},
        {'description': 'Install java 8', 'command': 'yum install -y java-1.8.0'},
